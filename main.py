...
def get_dados():
    urls = {
        ("Menor de 1 ano", "Masculino"): "http://tabnet.saude.mg.gov.br/csv/A16230910_14_8_2.csv",
        ...
        ("50 a 59 anos", "Feminino"): "http://tabnet.saude.mg.gov.br/csv/A13391210_14_8_2.csv",
